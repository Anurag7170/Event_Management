...
import aboutus from "../assets/EventImage/ritual-with-coconut-leaves-traditional-hindu-wedding-ceremony.jpg";
      ...
      <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-6 relative">
        <div className="md:col-span-5">
          <div className="relative">
            ...
            {/* <div className="absolute flex items-center bottom-16 md:-start-10 -start-5 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 w-50 m-3">
        ...
        <div className="md:col-span-7">
          <div className="lg:ms-8">
            <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
              Discover The Date <br />
              Transform Your Vision into Reality
            </h3>

            <p className="text-slate-400 max-w-xl mb-6">
            At The Date, we specialize in crafting memorable events tailored to your unique vision. With years
of experience and a passion for perfection, our team is dedicated to exceeding your expectations
